            ...
            <div class="container">
                <div class="row py-5">
                    <div class="col-span-12 md:col-span-4">
                        <h2 class="subHeading font-bold text-white">Contact Us</h2>
                        <ul>
                            <p class="heading text-white">ADP Traders</p>
                            <!-- <img src="/images/logo.jpeg" alt="" class="w-32 rounded-md my-2"> -->
                            <li class="text-white"><strong>Call :</strong> <a href="tel:8890505047">88905 05047</a></li>
                            <li class="text-white"><strong>Email : </strong><a href="mailto:info@pradeepclasses.in">info@pradeepclasses.in</a></li>
                            <li class="text-white">1174, SEC-45, Gurgaon, Haryana - 122002</li>
