...
{
    public $isOpen = 0, $initModal = 0, $model, $model_id, $model_options = [], $quest, $ans, $status, $display_order, $data_id;

    public function render(){ return view('deep::livewire.parts.faq-modal')->layout('layouts.admin'); }
    ...
    public function submit(){
        ...
        DB::transaction(function () {
            ...
            $this->dispatch('alert', ['type' => 'success', 'message' => $this->data_id ? 'Faq Updated Successfully.' : 'Faq Created Successfully.' ]);
