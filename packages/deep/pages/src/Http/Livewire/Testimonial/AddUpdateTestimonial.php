...
class AddUpdateTestimonial extends Component
{
    use WithPagination;
    ...
    public function render(){ return view('deep::livewire.testimonial.add-update-testimonial')->layout('layouts.admin'); }

    private function getData(){
        $this->data                 =   Testimonial::where([ ['model', $this->model], ['model_id', $this->model_id] ])->get();
    }
