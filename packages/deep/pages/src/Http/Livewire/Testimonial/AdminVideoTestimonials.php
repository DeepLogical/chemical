...
class AdminVideoTestimonials extends Component
{
    use WithPagination;
    ...
    public function render(){
        $data =   VideoTestimonial::search($this->search)->orderBy('id', 'DESC')->paginate($this->perPage);
        return view('deep::livewire.testimonial.admin-video-testimonials', ["data" => $data])->layout('layouts.admin');
    }
