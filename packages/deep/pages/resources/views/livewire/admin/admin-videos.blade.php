<div>
    @livewire('adminSearch', [ 'perPage' => isset($perPage), 'page' => 'Admin Video', 'routeName' => '', 'routeText' => 'Add Video', 'link' => 'true'])
                ...
                <div class="h-70 md:h-full p-2">
                    <form wire:submit.prevent="submit" method="POST" autocomplete="off">
                        <div class="row">
                            ...
                            <div class="col-span-12">
                                <label for="iframe" class="formLabel">Video URL</label>
                                <input type="text" wire:model.defer="iframe" class="formInput" placeholder="Add Slug" required>
